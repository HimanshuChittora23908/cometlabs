    ...
    return (
        <div className="p-8 bg-gradient-to-r from-[#6b7ed6] to-blue-400 mt-6 rounded-lg shadow-sm ">
            <div className="flex items-center gap-72">
                <div className="w-1/2 flex flex-col text-white items-start gap-4">
                ...
                <div className="bg-white px-4 py-2 w-40 rounded-lg shadow-md flex flex-col gap-4">
                    <div>
            ...
            <button className="px-4 py-1.5 shadow-md bg-[#586db6] rounded font-medium mt-4 text-white">Start now</button>
        </div>
    )
}
